...
inline bool operator==(const ComplexQuery::NodeID &lhs,
                       const ComplexQuery::NodeID &rhs) {
...
namespace std {
template <>
struct hash<nexus::scheduler::ComplexQuery::NodeID> {
  std::size_t operator()(
      const nexus::scheduler::ComplexQuery::NodeID &v) const {
